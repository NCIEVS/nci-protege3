...
public class NCIOWLSymbolPanel extends SymbolPanel {
	
	private static final long serialVersionUID = 441936038070346934L;
    ...
    public NCIOWLSymbolPanel(OWLModel owlModel, final boolean closable) {
        this(owlModel, closable, false);
    }


    public NCIOWLSymbolPanel(OWLModel owlModel, final boolean closable, boolean draggable) {
    ...
    protected void initMiddleBar(JToolBar middleBar) {
        ...
        rdfDatatypeAction = new ResourceSelectionAction("Insert datatype...",
        	...
        	private static final long serialVersionUID = 441936038070346940L;
        ...
        enumerationAction = new AbstractAction("Insert curly brackets for enumerations: { }",
        	...
        	private static final long serialVersionUID = 441936038070346941L;
        ...
        roundBracketsAction = new AbstractAction("Insert round brackets: ( )",
        	...
        	private static final long serialVersionUID = 441936038070346938L;
            public void actionPerformed(ActionEvent e) {
                getSymbolEditor().insertText("()", 1);
            }
        };
