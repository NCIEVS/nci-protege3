...
import edu.stanford.smi.protegex.prompt.operation.MoveInstanceDownOperation;
...
public class MoveInstanceDownOperationEditor extends Editor {
  static final String [] _responsibleFor = new String [] {
  	OPERATIONS_PACKAGE + "MoveInstanceDownOperation"};

  public static String getPrettyName () {
    return "move instance down";
  }
  ...
  public GetValueWidget [] createValueWidgets (boolean chooseOntology, boolean willBeModal) {
    ...
    _argumentWidgets[0] = new SelectInstanceWidget ("Source ontology", 0, chooseOntology, true, willBeModal);
  ...
  public Operation collectData () {
    ...
    boolean everythingRequired = ((Boolean)_argumentWidgets[1].getValue()).booleanValue();
   	...
   	result = new MoveInstanceDownOperation ((Instance)arg, everythingRequired);
