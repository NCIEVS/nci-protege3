...
public class QueryUIConfiguration implements Serializable, Localizable {
    ...
    public static final String PROTEGE_PROP_KEY_DEFAULT_SEARCH_TYPE = "query_plugin.default.search_type";
    ...
    private String queryDefaultSearchType;
    ...
    public QueryUIConfiguration(QueryUIConfiguration original) {
        ...
        queryDefaultSearchType = original.getDefaultQuerySearchType();
    ...
    public void save() {
        ...
        ApplicationProperties.setString(PROTEGE_PROP_KEY_DEFAULT_SEARCH_TYPE, queryDefaultSearchType.toString());
        for (BooleanConfigItem configItem : BooleanConfigItem.values()) {
    ...
    private void initOther() {
        ...
        queryDefaultSearchType = QueryComponent.EXACT_MATCH;
        String defaultSearchType = ApplicationProperties.getString(PROTEGE_PROP_KEY_DEFAULT_SEARCH_TYPE, QueryComponent.EXACT_MATCH);
        String munge = defaultSearchType.toLowerCase().replaceAll("_"," ");
        for (String possible : QueryComponent.DEFAULT_TYPES) {
        	if (possible.equals(munge)) {
        		queryDefaultSearchType = possible;
        		break;
        	}
        }
    }
    ...
    public String getDefaultQuerySearchType() {
		return queryDefaultSearchType;
	}
    
    public void setDefaultQuerySearchType(String filterResultsSearchType) {
		this.queryDefaultSearchType = filterResultsSearchType;
	}
