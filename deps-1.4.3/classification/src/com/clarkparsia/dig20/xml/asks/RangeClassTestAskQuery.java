...
public class RangeClassTestAskQuery extends RangeClassesAskQuery {

	private OWLDescription	desc;

	public RangeClassTestAskQuery(SAXHandlerParent<AsksQuerySAXHandler> parent, AskQueryType t,
